...
Cell(total_taxes_deducted, 9, Total taxes paid to be deducted, <|SUM(local_taxes, real_estate_taxes, property_taxes, other_taxes)|>, itemizing)
...
Cell(mort_insurance_premia, 13, Mortgage insurance premiums,, u itemizing mort)
