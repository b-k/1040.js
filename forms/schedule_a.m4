...
Cell(total_interest_deduction, 15, Total interest to deduct, <|SUM(reported_mort_interest, unreported_mort_interest, unreported_mort_points, investment_interest)|>, itemizing)
