...
Cell(mort_insurance_limit, 13.1, mort insurance limit, <|IF((CV(f1040,AGI) - Fswitch((married,50000),100000)) < 0, 1, max(0,min(1,1-Ceil((CV(f1040,AGI) - Fswitch((married, 50000), 100000))/1000)/10.0)))|>, itemizing mort)
