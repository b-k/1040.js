...
Cell(ws1_8582_net_gain, 0.1,"Net income", <|max(CV(rents_received), 0)|>, have_rr)
Cell(ws1_8582_net_loss, 0.2,"Net loss", <|min(CV(rents_received), 0)|>, have_rr)
...
Cell(f8582_magi_again, 7, "MAGI if positive", <|max(CV(MAGI), 0)|>, have_rr)

Cell(f8582_diff, 8, "Line 6 - Line 7", <|max(150000 - CV(f8582_magi_again), 0)|>, have_rr)
