...
function get_amt_exemption(income){
    ...
    if (s_or_hh && income<626350) return 88100
    if (mfj && income<1252700) return 137000
    if (status=="married filing separately" && income < 626350) return 68500
...
function get_tamt(income){
    ...
    return (status=="married filing separately")
       ? income * (income <=119550  ? 0.26 : 0.28) - 2391
       : income * (income <=239100 ? 0.26 : 0.28) - 4782
}
...
def get_amt_exemption(income):
    if (status=="single" or status=="head of household") and income < 626_350:
        return 88_100
    if (status=="married filing jointly") and income < 1_252_700:
        return 137_000
    if (status=="married filing separately") and income < 626_350:
        return 68_500
...
def get_tamt(income):
    ...
    if status=="married filing separately":
        return income * (0.26 if income <=119550  else 0.28) - 2391
    else:
        return income * (0.26 if income <=239100 else 0.28) - 4782
