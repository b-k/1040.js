...
Cell(baseline2, 13, <|67k or 134k|>, <|Fswitch((married filing jointly, 134000), 67000)|>,  s_loans)
...
m4_form(f8863ws)
Cell(credit_sum, 3, Lines 9 plus 18, <|CV(f8863, remaining_credit)+CV(f8863, frac_allowed)|>, s_loans)
Cell(tax, 4, Tax from 1040, <|CV(f1040, tax)|>, s_loans)
Cell(other_credits, 5, FTC and child care, <|CV(f1040sch3,ftc) + CV(f1040sch3, child_care)|>, s_loans)
Cell(diff, 6, Tax minus credits, <|max(0, CV(tax)-CV(other_credits))|>, s_loans)
Cell(limited_credit, 7, Limited nonrefundable credit, <|min(CV(diff), CV(credit_sum))|>, s_loans)
